 ...
 * generated in the com.atguigu.day01_ws.ws2 package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetStudentsByPriceResponse_QNAME = new QName("http://ws2.day01_ws.atguigu.com/", "getStudentsByPriceResponse");
    private final static QName _GetStudentById_QNAME = new QName("http://ws2.day01_ws.atguigu.com/", "getStudentById");
    private final static QName _GetAllStudentsMap_QNAME = new QName("http://ws2.day01_ws.atguigu.com/", "getAllStudentsMap");
    private final static QName _AddStudentResponse_QNAME = new QName("http://ws2.day01_ws.atguigu.com/", "addStudentResponse");
    private final static QName _GetAllStudentsMapResponse_QNAME = new QName("http://ws2.day01_ws.atguigu.com/", "getAllStudentsMapResponse");
    private final static QName _GetStudentByIdResponse_QNAME = new QName("http://ws2.day01_ws.atguigu.com/", "getStudentByIdResponse");
    private final static QName _GetStudentsByPrice_QNAME = new QName("http://ws2.day01_ws.atguigu.com/", "getStudentsByPrice");
    private final static QName _AddStudent_QNAME = new QName("http://ws2.day01_ws.atguigu.com/", "addStudent");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.atguigu.day01_ws.ws2
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws2.day01_ws.atguigu.com/", name = "getStudentsByPriceResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws2.day01_ws.atguigu.com/", name = "getStudentById")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws2.day01_ws.atguigu.com/", name = "getAllStudentsMap")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws2.day01_ws.atguigu.com/", name = "addStudentResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws2.day01_ws.atguigu.com/", name = "getAllStudentsMapResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws2.day01_ws.atguigu.com/", name = "getStudentByIdResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws2.day01_ws.atguigu.com/", name = "getStudentsByPrice")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws2.day01_ws.atguigu.com/", name = "addStudent")
