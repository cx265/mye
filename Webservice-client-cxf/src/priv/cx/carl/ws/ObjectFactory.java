 ...
 * generated in the priv.cx.carl.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetOrderById_QNAME = new QName("http://ws.carl.cx.priv/", "getOrderById");
    private final static QName _GetOrderByIdResponse_QNAME = new QName("http://ws.carl.cx.priv/", "getOrderByIdResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: priv.cx.carl.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.carl.cx.priv/", name = "getOrderById")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.carl.cx.priv/", name = "getOrderByIdResponse")
